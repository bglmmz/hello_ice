package com.bglmmz.ice.demo.helloworld.blobject.server;

import com.bglmmz.ice.demo.helloworld.impl.HelloServiceBlobjectImpl;
...
public class HelloServer {
    public static void main(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator ic = com.zeroc.Ice.Util.initialize(args)){
            ...
            System.out.println("创建对象适配器，监听端口10002...");
            ...
            com.zeroc.Ice.ObjectAdapter adapter = ic.createObjectAdapterWithEndpoints("HelloServiceAdapter", "default -p 10002");

            // 实例化一个PrinterI对象，为Printer接口创建一个servant
            System.out.println("为接口创建servant...");
            //Servant 是一个实现了slice中定义的接口，可以认为就是个服务
            com.zeroc.Ice.Object object = new HelloServiceBlobjectImpl();
